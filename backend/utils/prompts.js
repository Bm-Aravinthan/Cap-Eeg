const researchPostIdeasPrompt = (topic) => `
    Generate a list of 5 research post ideas related to ${topic}.

For each research post idea, return:
- a title
...
function generateReplyPrompt(comment) {
  ...
  return `You're replying to a research comment by ${authorName}. The comment says:
...
const researchSummaryPrompt = (researchContent) => `
  You are an AI assistant that summarizes research posts.
  
  Instructions:
  - Read the research post content below.
